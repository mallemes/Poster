...
<div class="main-wrap">
    <div class="nav-header bg-transparent shadow-none border-0">
        <div class="nav-top w-100">
            <a href="/"><i class="feather-zap text-success display1-size me-2 ms-0"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Sociala. </span> </a>
            ...
            <div class="card shadow-none border-0 ms-auto me-auto login-card">
                <div class="card-body rounded-0 text-left container-sm" >
                    ...
                    <form method="post" action="{{route('register')}}" >
                        ...
                        <div class="form-group icon-input mb-2">
                            <i class="font-sm ti-user text-grey-500 pe-0"></i>
                            <input type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" name="firstname" placeholder="Your first Name">
                            @error('firstname')
                            <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
{{--                        <div class="form-group icon-input mb-2">--}}
{{--                            <i class="font-sm ti-user text-grey-500 pe-0"></i>--}}
{{--                            <input type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" name="surname" placeholder="Your surname">--}}
{{--                            @error('surname')--}}
...
{{--                        </div>--}}
                        <div class="form-group icon-input mb-2">
                            ...
                            <input type="email" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" name="email" placeholder="Your Email Address">
                            @error('email')
                            <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                        ...
                        <div class="form-group icon-input mb-2">
                            <input type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" name="password_confirmation" placeholder="conf Password">
                            <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                        </div>
                    <div class="col-sm-12 p-0 text-left">
                        <div class="form-group mb-1"><button class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0">Register</button></div>
