...
<div class="main-wrapper">
    ...
    <div class="nav-header bg-white shadow-xs border-0">
        ...
        @auth()
            <a href="{{ route('profile.index', \Illuminate\Support\Facades\Auth::user()->username) }}" class="p-0 ms-3 menu-icon"><img src="{{ asset(\Illuminate\Support\Facades\Auth::user()->image) }}" alt="user" class="w40 mt--1"></a>
        @endauth
    </div>
    <!-- navigation top -->
