...
<head>
    ...
    <link rel="stylesheet" href="{{ assert('base/css/emoji.css') }}">

    <link rel="stylesheet" href="{{ asset('base/css/lightbox.css') }}">
...
<div class="main-wrapper">
    ...
    <div class="nav-header bg-white shadow-xs border-0">
        <div class="nav-top">
            <a href="index.html"><i class="bx bxs-zap text-success display1-size me-2 ms-0"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Poster. </span> </a>
        ...
        <form action="#" class="float-left header-search" style="margin-top: 20px">
            <div class="form-group mb-0 icon-input">
                <i class="bx bx-search font-sm text-grey-400"></i>
        ...
        <a href="#" class="p-2 text-center ms-auto menu-icon" id="dropdownMenu3" data-bs-toggle="dropdown" aria-expanded="false"><span class="dot-count bg-warning"></span><i class="bx bx-bell font-xl text-current"></i></a>
        <div class="dropdown-menu dropdown-menu-end p-4 rounded-3 border-0 shadow-lg" aria-labelledby="dropdownMenu3">
            <h4 class="fw-700 font-xss mb-4">Notification</h4>
            <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                <img src="{{ asset('base/images/user-8.png') }}" alt="user" class="w40 position-absolute left-0">
            ...
            <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                <img src="{{ asset('base/images/user-4.png') }}" alt="user" class="w40 position-absolute left-0">
            ...
            <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                <img src="{{ asset('base/images/user-7.png') }}" alt="user" class="w40 position-absolute left-0">
            ...
            <div class="card bg-transparent-card w-100 border-0 ps-5">
                <img src="{{ asset('base/images/user-6.png') }}" alt="user" class="w40 position-absolute left-0">
        ...
        <a href="#" class="p-2 text-center ms-3 menu-icon chat-active-btn"><i class="bx bx-message-square font-xl text-current"></i></a>
        <div class="p-2 text-center ms-3 position-relative dropdown-menu-icon menu-icon cursor-pointer">
            <i class="bx bx-cog animation-spin d-inline-block font-xl text-current"></i>
        ...
        <a href="#" class="p-0 ms-3 menu-icon"><img src="{{ asset('base/images/profile-4.png') }}" alt="user" class="w40 mt--1"></a>
    ...
    <div class="app-footer border-0 shadow-lg bg-primary-gradiant">
        ...
        <a href="default-settings.html" class="nav-content-bttn"><img src="{{ asset('base/images/female-profile.png') }}" alt="user" class="w30 shadow-xss"></a>
    </div>
            ...
            <div class="modal-body p-0">
                <div class="card w-100 border-0 rounded-3 overflow-hidden bg-gradiant-bottom bg-gradiant-top">
                    <div class="owl-carousel owl-theme dot-style3 story-slider owl-dot-nav nav-none">
                        <div class="item"><img src="{{ asset('base/images/story-5.jpg') }}" alt="image"></div>
                        <div class="item"><img src="{{ asset('base/images/story-6.jpg') }}" alt="image"></div>
                        <div class="item"><img src="{{ asset('base/images/story-7.jpg') }}" alt="image"></div>
                        <div class="item"><img src="{{ asset('base/images/story-8.jpg') }}" alt="image"></div>
        ...
        <div class="modal-popup-header w-100 border-bottom">
            <div class="card p-3 d-block border-0 d-block">
                <figure class="avatar mb-0 float-left me-2">
                    <img src="{{ asset('base/images/user-12.png') }}" alt="image" class="w35 me-1">
                </figure>
