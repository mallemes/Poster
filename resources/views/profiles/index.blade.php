...
@section('title', $user->username . ' - профиль')
                    ...
                    <div class="col-lg-12">
                        <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
                            ...
                            <div class="card-body p-0 position-relative">
                                ...
                                @if(!$user->is_online)
                                        <span class="fw-500 font-xssss text-grey-500 mt-1 mb-3 d-block">{{ \Carbon\Carbon::parse(\Carbon\Carbon::parse($user->last_seen_at)->diffForHumans())->format('Был в сети в H:i') }}</span>
                                    @endif
                                </h4>
                                <div
